...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Vendor Manage</div>
        <div class="ps-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method='post' enctype="multipart/form-data"
                                action="{{ route('active.vendor.approve') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea name="vendor_short_info" id="" rows="3" class="form-control"
                                            placeholder="...">{{ $inactiveVendorDetails->vendor_short_info }}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage"
                                            ...
                                            alt="Vendor" width='100' height='100'>
                                    </div>
                                </div>
                                <div class="row">
