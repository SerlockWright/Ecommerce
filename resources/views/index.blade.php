                            ...
                            <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <img id="showImage" alt="User" class="rounded-circle p-1 bg-primary" width='110'
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input id="image" required="" class="form-control" name="photo"
                                                        type="file" />
                                                </div>
                                                <div class="form-group col-md-12">
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input id="new_password_confirmation" class="form-control"
